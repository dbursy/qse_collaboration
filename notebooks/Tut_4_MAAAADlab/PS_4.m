...
BASE.r_a          = 100 * ones(height(BASE), 1);
...
[BASE,L_hat_demand, L_hat_supply, sL, sy, x0, x1, iter_cnt] = FINDEQ(BASE, params);
...
GHEIGHT(BASE);
saveas(gcf, fullfile(thisFolder, 'GHEIGHT.png'));


GBIDRENT(BASE);
saveas(gcf, 'GBIDRENT.png');

GLANDRENT(BASE);
saveas(gcf, 'GLANDRENT.png');
