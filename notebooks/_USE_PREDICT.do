...
* A1) PREPARE TARGET DATA SET
	u "data/ahs_index/centroids.dta", clear
...
* A2) LOAD COORDINATES
	do "resources/AHS2023-toolkit-main/DOS/_AUX_READCOORD"
* A3) RUN PROGRAM
	u $transaction_dataset, clear
...
PREDICT  1 $N   2007 2022  5 10 25 50 20000 1 2 5 10 1000	// $N selects all observations 
...
// Label variables
	...
	save "data/ahs_index/AHS-Index", replace
...
* A4) SAVE OUTPUT ON SERVER AND H-DRIVE
	...
	export delimited using  "data/ahs_index/AHS-Index.csv", replace		
